export const elements = [
  ...
  { number: 31, symbol: "Ga", name: "Gallium", mass: 69.723, category: "post-transition", period: 4, group: 13 },
  ...
  { number: 49, symbol: "In", name: "Indium", mass: 114.82, category: "post-transition", period: 5, group: 13 },
  { number: 50, symbol: "Sn", name: "Tin", mass: 118.71, category: "post-transition", period: 5, group: 14 },
  ...
  { number: 58, symbol: "Ce", name: "Cerium", mass: 140.12, category: "lanthanide", period: 8, group: 3 },
  { number: 59, symbol: "Pr", name: "Praseodymium", mass: 140.91, category: "lanthanide", period: 8, group: 4 },
  { number: 60, symbol: "Nd", name: "Neodymium", mass: 144.24, category: "lanthanide", period: 8, group: 5 },
  { number: 61, symbol: "Pm", name: "Promethium", mass: 145, category: "lanthanide", period: 8, group: 6 },
  { number: 62, symbol: "Sm", name: "Samarium", mass: 150.36, category: "lanthanide", period: 8, group: 7 },
  { number: 63, symbol: "Eu", name: "Europium", mass: 151.96, category: "lanthanide", period: 8, group: 8 },
  { number: 64, symbol: "Gd", name: "Gadolinium", mass: 157.25, category: "lanthanide", period: 8, group: 9 },
  { number: 65, symbol: "Tb", name: "Terbium", mass: 158.93, category: "lanthanide", period: 8, group: 10 },
  { number: 66, symbol: "Dy", name: "Dysprosium", mass: 162.50, category: "lanthanide", period: 8, group: 11 },
  { number: 67, symbol: "Ho", name: "Holmium", mass: 164.93, category: "lanthanide", period: 8, group: 12 },
  { number: 68, symbol: "Er", name: "Erbium", mass: 167.26, category: "lanthanide", period: 8, group: 13 },
  { number: 69, symbol: "Tm", name: "Thulium", mass: 168.93, category: "lanthanide", period: 8, group: 14 },
  { number: 70, symbol: "Yb", name: "Ytterbium", mass: 173.05, category: "lanthanide", period: 8, group: 15 },
  { number: 71, symbol: "Lu", name: "Lutetium", mass: 174.97, category: "lanthanide", period: 8, group: 16 },
  ...
  { number: 81, symbol: "Tl", name: "Thallium", mass: 204.38, category: "post-transition", period: 6, group: 13 },
  { number: 82, symbol: "Pb", name: "Lead", mass: 207.2, category: "post-transition", period: 6, group: 14 },
  { number: 83, symbol: "Bi", name: "Bismuth", mass: 208.98, category: "post-transition", period: 6, group: 15 },
  ...
  { number: 90, symbol: "Th", name: "Thorium", mass: 232.04, category: "actinide", period: 9, group: 3 },
  { number: 91, symbol: "Pa", name: "Protactinium", mass: 231.04, category: "actinide", period: 9, group: 4 },
  { number: 92, symbol: "U", name: "Uranium", mass: 238.03, category: "actinide", period: 9, group: 5 },
  { number: 93, symbol: "Np", name: "Neptunium", mass: 237, category: "actinide", period: 9, group: 6 },
  { number: 94, symbol: "Pu", name: "Plutonium", mass: 244, category: "actinide", period: 9, group: 7 },
  { number: 95, symbol: "Am", name: "Americium", mass: 243, category: "actinide", period: 9, group: 8 },
  { number: 96, symbol: "Cm", name: "Curium", mass: 247, category: "actinide", period: 9, group: 9 },
  { number: 97, symbol: "Bk", name: "Berkelium", mass: 247, category: "actinide", period: 9, group: 10 },
  { number: 98, symbol: "Cf", name: "Californium", mass: 251, category: "actinide", period: 9, group: 11 },
  { number: 99, symbol: "Es", name: "Einsteinium", mass: 252, category: "actinide", period: 9, group: 12 },
  { number: 100, symbol: "Fm", name: "Fermium", mass: 257, category: "actinide", period: 9, group: 13 },
  { number: 101, symbol: "Md", name: "Mendelevium", mass: 258, category: "actinide", period: 9, group: 14 },
  { number: 102, symbol: "No", name: "Nobelium", mass: 259, category: "actinide", period: 9, group: 15 },
  { number: 103, symbol: "Lr", name: "Lawrencium", mass: 266, category: "actinide", period: 9, group: 16 },
  ...
  { number: 114, symbol: "Fl", name: "Flerovium", mass: 289, category: "unknown", period: 7, group: 14 },
...
export const categories = {
  "alkali-metal": { name: "Alkali Metal", color: "#ff6b6b" },
  "alkaline-earth": { name: "Alkaline Earth Metal", color: "#feca57" },
  "transition-metal": { name: "Transition Metal", color: "#54a0ff" },
  "post-transition": { name: "Post-Transition Metal", color: "#5f27cd" },
  "metalloid": { name: "Metalloid", color: "#00d2d3" },
  "nonmetal": { name: "Nonmetal", color: "#10ac84" },
  "halogen": { name: "Halogen", color: "#ee5a24" },
  "noble-gas": { name: "Noble Gas", color: "#f368e0" },
  "lanthanide": { name: "Lanthanide", color: "#ff9ff3" },
  "actinide": { name: "Actinide", color: "#c8d6e5" },
  "unknown": { name: "Unknown", color: "#576574" },
};
